export class Wand
{
    ...
    initializeWand ()
    {
        ...
        wandSettings.appendChild(blurRadius);
        wandSettings.appendChild(this.threshold);
        document.body.appendChild(wandSettings);

        document.getElementById("blurRadius").value = this.blurRadius;
        //setInterval(function () { this.hatchTick(); }, 300);
        setInterval(() => { this.hatchTick(); }, 3000);
    ...
    drawMask (x, y)
    {
        ...
        //REFER HERE COME BACK
        // TODO: make magic wand function
        this.mask = this.MagicWand.floodFill(image, x, y, this.currentThreshold);
        this.mask = this.MagicWand.gaussBlurOnlyBorder(this.mask, this.blurRadius);
        this.drawBorder();
    }

    hatchTick ()
    {
        console.log("inside hatchtick!");
    ...
    drawBorder (noBorder)
    {
        ...
        if (!noBorder)
        {
            // TODO: link to magic wand function
            this.cacheInd = this.MagicWand.getBorderIndices(this.mask);
        }
    ...
    trace ()
    {
        ...
        cs = this.MagicWand.simplifyContours(cs, this.simplifyTolerant, this.simplifyCount);
